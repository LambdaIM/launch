...
![avatar](img/asset/asset10.png)

这里填写矿工价格信息时候，需要在浏览器中查找合适的矿工

点击“在浏览器中查找矿工价格信息”即可跳转到浏览器中对应的市场

![avatar](img/asset/asset11.png)
再找到合适的矿工，复制矿工价格信息，填写到钱包中
...
完成赎回操作后，在赎回列表，可以看到赎回记录，和完成赎回的时间
