...
3. 提交挖矿证明  
   每个区块选择1名矿工提交挖矿证明，存储算力越大被选中概率越高  
   挖矿证明需要在5个区块周期内提交  
  
4. 获得出块奖励  
   出块奖励的43% 给提交挖矿证明的这名矿工  
...
操作文档参考：[匹配订单续期](http://docs.lambda.im/Mainnet-Miner-Guide/#3_1)
...
./storagenode info  disk  --local-mode   
               version:  0.3.2-13-gdbcabcf-debug
