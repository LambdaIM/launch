...
!!! example ""
    !!! abstract ""
        ...
        可选的6个Lambda官方验证节点IP如下（注意尽量用自己的节点IP，官方验证节点会限流）:  
...
!!! example ""
    ...
    - `[validator-address]` 质押的节点地址，可指定 自己的验证节点地址 或 Lambda官方节点地址，节点地址可通过浏览器查找 [http://explorer.lambda.im/#/](http://explorer.lambda.im/#/) 或询问节点  
